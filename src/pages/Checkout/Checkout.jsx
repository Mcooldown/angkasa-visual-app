                                             ...
                                             cartItems.length > 0 ? cartItems.map((cartItem) => {
                                                  return (
                                                       <OrderItem key={cartItem.id} id={cartItem.id} image={cartItem.product_image} notes={cartItem.notes} packageName={cartItem.package_name}
                                                            preferredDesigner={cartItem.designer_name} price={new Intl.NumberFormat('ban-ID', { style: 'currency', currency: 'IDR' }).format(cartItem.price)} productName={cartItem.product_name} quantity={cartItem.quantity}
                                   ...
                                   <div className="cCheckoutFormCard">
                                        {
                                             ...
                                             <div className="d-flex justify-content-center align-items-center">
                                                  ...
                                                  <Gap width={15} />
                                                  <h1 className="subHeading2 text-danger">{new Intl.NumberFormat('ban-ID', { style: 'currency', currency: 'IDR' }).format(subTotal)}</h1>
                                             </div>
                                        }
                                        <Gap height={40} />
